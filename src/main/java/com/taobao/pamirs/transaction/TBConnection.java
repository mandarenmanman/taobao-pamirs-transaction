...
public class TBConnection implements java.sql.Connection {
	...
	public Statement createStatement() throws SQLException {
		return new TBStatement(this, m_conn.createStatement(), m_queryTimeOut,this.m_session != null);
	}

	public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
		return new TBStatement(this, m_conn.createStatement(resultSetType, resultSetConcurrency), this.m_queryTimeOut,this.m_session != null);
	}

	public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability)
			throws SQLException {
		return new TBStatement(this, this.m_conn.createStatement(resultSetType, resultSetConcurrency,
				resultSetHoldability), this.m_queryTimeOut,this.m_session != null);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency,
		...
		return new TBPreparedStatement(this, this.m_conn.prepareStatement(sql, resultSetType, resultSetConcurrency,
				resultSetHoldability), sql, this.m_queryTimeOut,this.m_session != null);

	}

	public PreparedStatement prepareStatement(String sql, int columnIndexes[]) throws SQLException {
		return new TBPreparedStatement(this, this.m_conn.prepareStatement(sql, columnIndexes), sql, this.m_queryTimeOut,this.m_session != null);
	}

	public PreparedStatement prepareStatement(String sql, String columnNames[]) throws SQLException {
		return new TBPreparedStatement(this, this.m_conn.prepareStatement(sql, columnNames), sql, this.m_queryTimeOut,this.m_session != null);
	}
	...
	public java.sql.CallableStatement prepareCall(String sql) throws SQLException {
		return new TBCallableStatement(this, m_conn.prepareCall(sql), sql, this.m_queryTimeOut,this.m_session != null);
	...
	public java.sql.CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency)
		...
		return new TBCallableStatement(this, m_conn.prepareCall(sql, resultSetType, resultSetConcurrency), sql,
				this.m_queryTimeOut,this.m_session != null);
	}
	...
	public java.sql.PreparedStatement prepareStatement(String sql) throws SQLException {
		return new TBPreparedStatement(this, m_conn.prepareStatement(sql), sql, this.m_queryTimeOut,this.m_session != null);
	}
